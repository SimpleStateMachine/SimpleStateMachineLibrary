...
namespace SimpleStateMachineLibrary
{
    ...
    {
        public partial class Transition : NamedObject<TKeyTransition, TKeyState, TKeyTransition, TKeyData>
        {
            public TKeyState StateFrom { get; private set; }

            public TKeyState StateTo { get; private set; }

            private Action<Transition, Dictionary<string, object>> _onInvoke;

            internal Transition(StateMachine<TKeyState, TKeyTransition, TKeyData> stateMachine, TKeyTransition nameTransition, TKeyState stateFrom, TKeyState stateTo, Action<Transition, Dictionary<string, object>> actionOnInvoke, bool withLog) : base(stateMachine, nameTransition)
            {
            ...
            public InvokeParameters<TKeyState, TKeyTransition, TKeyData> Invoke(Dictionary<string, object> parameters)
            {
